...
- If using Android 16 and above make sure you use a recent version of xDrip (at least the [latest release](../download/#latest-release), we'll talk about it later: continue reading).
